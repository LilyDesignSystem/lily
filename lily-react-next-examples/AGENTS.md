...
- **Package**: lily-react-next-examples
- **Version**: 0.2.0
- **Created**: 2026-03-03
...
React 19 + Next.js 15 example application demonstrating all 316 components from the Lily Design System headless component library, styled with NHS UK design system colors, typography, spacing, and focus states.
...
{
  "@/*": ["./*"],
  "@pgds/*": ["../lily-react-headless/components/*"]
}
```
