# Lily Design System — React Next.js Examples — Implementation Plan

## Goal

Create styled example pages demonstrating component usage with Next.js 15 + React 19 with simple styling. Examples use NHS UK design system CSS for visual styling on top of headless components.

## Technology

- Framework: Next.js 15 + React 19 with simple styling
- Test framework: Vitest
- Test command: `npx vitest run`
- Component directory: src/app/
