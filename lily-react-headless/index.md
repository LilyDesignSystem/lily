...
A comprehensive headless React component library with 316 accessible, unstyled components for building design systems. Every component follows WCAG 2.2 AAA guidelines with full ARIA support, keyboard navigation, and internationalization readiness.
...
```bash
npm install lily-react-headless
```
...
import Button from "lily-react-headless/components/Button";
import TextInput from "lily-react-headless/components/TextInput";
import Alert from "lily-react-headless/components/Alert";
...
```bash
git clone https://github.com/lily/lily-react-headless.git
cd lily-react-headless
npm install
```
