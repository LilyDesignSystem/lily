...
- Component: vital-sign-waist-circumference-as-cm-input
- PascalCase: VitalSignWaistCircumferenceAsCmInput
- Description: number input of one vital sign waist circumference in centimetres with integers
- HTML tag: <input>
- CSS class: .vital-sign-waist-circumference-as-cm-input
- Interactive: yes
...
- Companion to VitalSignWaistCircumferenceAsCmView for the Input/View pattern
...
- [ ] Renders <input> element with class="vital-sign-waist-circumference-as-cm-input"
...
- CSS class: .vital-sign-waist-circumference-as-cm-input in css-style-sheet-template.css
- HTML headless: lily-design-system-html-headless/components/vital-sign-waist-circumference-as-cm-input.html
