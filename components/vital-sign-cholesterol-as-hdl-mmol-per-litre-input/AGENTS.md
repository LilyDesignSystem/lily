...
- Component: vital-sign-cholesterol-as-hdl-mmol-per-litre-input
- PascalCase: VitalSignCholesterolAsHdlMmolPerLitreInput
- Description: number input of one vital sign cholesterol HDL (good cholesterol) millimole per litre with one decimal point
- HTML tag: <input>
- CSS class: .vital-sign-cholesterol-as-hdl-mmol-per-litre-input
- Interactive: yes
...
- [ ] Renders <input> element with class="vital-sign-cholesterol-as-hdl-mmol-per-litre-input"
...
- CSS class: .vital-sign-cholesterol-as-hdl-mmol-per-litre-input in css-style-sheet-template.css
- HTML headless: lily-design-system-html-headless/components/vital-sign-cholesterol-as-hdl-mmol-per-litre-input.html
