...
- Component: vital-sign-cholesterol-as-ldl-mmol-per-litre-view
- PascalCase: VitalSignCholesterolAsLdlMmolPerLitreView
- Description: number display of one vital sign cholesterol LDL (bad cholesterol) millimole per litre with one decimal point
- HTML tag: <div>
...
- Companion to VitalSignCholesterolAsLdlMmolPerLitreInput for the Input/View pattern
...
- [ ] Renders <div> element with class="vital-sign-cholesterol-as-ldl-mmol-per-litre-view"
...
- CSS class: .vital-sign-cholesterol-as-ldl-mmol-per-litre-view in css-style-sheet-template.css
- HTML headless: lily-design-system-html-headless/components/vital-sign-cholesterol-as-ldl-mmol-per-litre-view.html
