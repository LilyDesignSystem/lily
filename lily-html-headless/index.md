...
A headless plain HTML component library with 316 components. All components are headless (no built-in styles), fully accessible (WCAG 2.2 AAA), and use vanilla JavaScript for interactivity.
...
- \*Bar \*BarButton: MenuBar, TabBar, TaskBar, ToolBar
- \*Group \*GroupItem: SegmentGroup
...
- \*Input \*View: PostalCode, Measurement, VitalSign components
...
- **Plain HTML** with vanilla JavaScript for interactivity
...
- **Zero dependencies**: works in any browser without build tools
...
```html
<div class="alert" role="alert" data-type="info">
...
<nav class="breadcrumb-nav" aria-label="Breadcrumb">
  <ol class="breadcrumb-list">
    ...
    <li class="breadcrumb-list-item"><a href="/products">Products</a></li>
    <li class="breadcrumb-list-item" aria-current="page">Widget Pro</li>
  </ol>
</nav>
```
...
```html
<dialog class="dialog" aria-label="Confirm deletion">
...
```html
<form class="form" aria-label="Contact">
  <div class="field">
...
<div class="grail-layout">
  <header class="grail-layout-top-header">Header</header>
  <aside class="grail-layout-left-aside">Left sidebar</aside>
  <main class="grail-layout-center-main">Main content</main>
  <aside class="grail-layout-right-aside">Right sidebar</aside>
  <footer class="grail-layout-bottom-footer">Footer</footer>
</div>
```
...
```html
<button
  class="button bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700"
>
  Save
</button>
```
...
No strings are hardcoded in any component. All user-facing text comes through HTML content, attributes, or JavaScript configuration. Labels, placeholders, and error messages are all configurable by the consumer.

## Related Projects

- [Lily Design System](https://github.com/LilyDesignSystem/lily) — Parent project
- [Svelte Headless](../lily-svelte-headless/) — Svelte equivalent
- [React Headless](../lily-react-headless/) — React equivalent
- [Vue Headless](../lily-vue-headless/) — Vue equivalent
- [Blazor Headless](../lily-blazor-headless/) — Blazor equivalent
