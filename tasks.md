...
- [x] Create canonical component list (321 components)
...
- [x] Harmonize component count across plan.md, tasks.md (321)
...
- [x] Deduplicate components.csv (325 → 321)
...
- [x] Add live component demos to /components/{slug} pages in all 5 example subprojects
  - [x] Generate component-demos.ts for lily-design-system-svelte-sveltekit-examples (321 demos)
  - [x] Generate component-demos.ts for lily-design-system-react-next-examples (321 demos)
  - [x] Generate component-demos.ts for lily-design-system-vue-nuxt-examples (321 demos)
...
- [x] Harmonize all 10 subproject files (index.md, AGENTS.md, plan.md, tasks.md)
  - [x] Fix "316" → "321" component count across all subproject index.md and AGENTS.md
...
- [ ] Verify all subprojects have all 321 canonical components implemented
